# REDO MCI v CONTROL (using all samples for fitting)
...
parser$add_argument("--odir", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/MCI_CONTROL/test-diagnostic-group-coded/")
...
parser <- ArgumentParser()
parser$add_argument("--idir", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/MCI_CONTROL/test-diagnostic-group-coded/", help='Where are the models stored')
parser$add_argument("--odir_pis", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/MCI_CONTROL/Outputs/Pis/", help='Where are the models stored')
parser$add_argument("--odir_summaries", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/MCI_CONTROL/Outputs/Summaries/", help='Where are the models stored')
