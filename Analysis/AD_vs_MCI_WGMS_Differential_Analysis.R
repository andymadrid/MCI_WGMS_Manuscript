# REDO LOAD v MCI (using all samples for fitting)
...
#removeIDs <- read.table("removeSamples.txt",header=T)
...
parser$add_argument("--odir", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/test-diagnostic-group-coded/")
...
df$diagnostic_group <- factor(df$diagnostic_group, levels = c("LOAD", "MCI", "CONTROL"))
...
test.result <- DMLtest.multiFactor(dml.fit, coef = "diagnostic_groupMCI")
...
parser <- ArgumentParser()
parser$add_argument("--idir", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/test-diagnostic-group-coded/", help='Where are the models stored')
parser$add_argument("--odir_pis", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/Outputs/Pis/", help='Where are the models stored')
parser$add_argument("--odir_summaries", default= "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/Outputs/Summaries/", help='Where are the models stored')
